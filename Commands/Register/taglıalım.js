...
let embed = new Discord.MessageEmbed().setFooter("").setTimestamp().setColor("010000").setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setTimestamp();
let no = client.emojis.cache.get(":x:")
let yes = client.emojis.cache.get(":white_check_mark:")
