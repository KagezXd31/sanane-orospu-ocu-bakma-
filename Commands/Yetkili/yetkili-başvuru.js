...
let seviyebaş = "885229794105643008";
let seviyeileri = "885229790066524200";
let seviyeorta = "885229785352138753";
let seviyeson = "885229782646796319";
...
exports.run = (client, message, args) => {
  ...
  client.channels.cache.get("885229772593045534").send(
    new Discord.MessageEmbed()
      .setColor("GREEN")
      ...
      .addField(
        ...
        ` Kullanıcı Adı: <@${message.author.id}> \n Kullanıcı ID: \`${
          message.author.id
        }\` \n İlgilenecek Yetkili: <@&885229772593045534> \n Tarih: \`${moment().format(
          "DD/MM/YYYY | H:mm:ss"
        )}\` `
      )
      .addField(
